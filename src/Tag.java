...
/**
 * NBT IO class
 * Copied from official minecraft.net page (<a href="https://minecraft.gamepedia.com/Development_resources/Example_NBT_Class">Minecraft nbt example class</a>)
 * @author udoprog
...
public class Tag {
    ...
    /**
     * a non-recursive version of the findNextTagByName() function
     * @param name name to search for
     * @return the tag if found any null if none was found
     */
     ...
     * a non-recursive version of the findNextTagByName() function
     * @param name name to search for
     * @param found the previously found tag
     * @return the tag if found any. null if none was found
     */
